    ...
    class Htmx {
        ...
        constructor() {
            ...
            this.#internalAPI = {
                ...
                parseSwapSpec: this.__parseSwapSpec.bind(this),
                runViewTransition: this.__runViewTransition.bind(this),
        ...
        async swap(ctx) {
            try {
                ...
                if (documentTransitionTasks.length > 0) {
                    ...
                    swapPromises.push(this.__submitTransitionTask(tasksWrapper, ctx.sourceElement));
                }
                ...
                for (let [target, targetTasks] of targetTransitionTasks) {
                    ...
                    let transition = this.__runViewTransition('target', target, tasksWrapper, ctx.sourceElement);
        ...
        __runViewTransition(mode, root, update, sourceElement = root) {
            ...
            let immediate = (detail = null) => {
                ...
                if (detail) {
                    finished = finished.finally(() => {
                        this.__trigger(transitionRoot, "htmx:after:viewTransition", detail);
                    });
                }
                return {
                    transition: null,
            ...
            if (!this.__trigger(transitionRoot, "htmx:before:viewTransition", detail)) {
                detail.skipped = true;
                detail.cancelled = true;
        ...
        __submitTransitionTask(task, sourceElement) {
        ...
        async __processTransitionQueue() {
            ...
            try {
                let transition = this.__runViewTransition(true, document, task, sourceElement);
